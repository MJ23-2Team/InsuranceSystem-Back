...
public class OperationPolicyList {
    ...
    public void recommendOperationPolicy(int id) {
    ...
    public List<OperationPolicyRecommendResponse> geteRecommendedPolicy() {
        return operationPolicyRepository.findPass().stream().map(OperationPolicyRecommendResponse::of).collect(Collectors.toList());
    }
}
